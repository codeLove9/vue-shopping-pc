  ...
  <div>
    ...
    <div class="main">
      <div class="py-container">
        ...
        <!--selector-->
        <SearchSelector @trademarkInfo = "trademarkInfo1" @attrInfo = 'attrInfo1' />
            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{ active:  isActive }" @click="changeOrder(1)">
                  <a>综合<span v-if="isActive" class="iconfont" :class="{ 'icon-up': isAsc, 'icon-down': !isAsc }"></span></a>
                </li>
                <li :class="{ active: !isActive }" @click="changeOrder(2)">
                  <a>价格<span v-if="!isActive" class="iconfont" :class="{ 'icon-up': isAsc, 'icon-down': !isAsc }"></span></a>
                </li>
              </ul>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    changeOrder(flag) {
      ...
      let originFlag = originOrder.slice(0,1)
      let originSort = originOrder.slice(2)
