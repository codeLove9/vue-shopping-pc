          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                v-for="spuSaleAttrValueList in spuSaleAttr.spuSaleAttrValueList" 
                :key="spuSaleAttrValueList.id"    
                @click="changeActive(spuSaleAttrValueList, spuSaleAttr.spuSaleAttrValueList)">{{ spuSaleAttrValueList.saleAttrValueName }}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
