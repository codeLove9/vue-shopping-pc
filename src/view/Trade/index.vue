<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix"  v-for="address in addressInfo" :key="address.id" @click="changeDefaultAddress(address, addressInfo)">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        ...
        收货人：<span>{{ lastSelectedAddress.consignee }}</span>
        <span>{{ lastSelectedAddress.phoneNum }}</span>
      </div>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      async submitOrder() {
        ...
        let data = {
          consignee: this.lastSelectedAddress.consignee,
          consigneeTel: this.lastSelectedAddress.phoneNum,
          deliveryAddress: this.lastSelectedAddress.fullAddress,
          paymentWay: 'ONLINE',
